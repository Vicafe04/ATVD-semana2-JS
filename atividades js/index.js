...
var btnCPF = document.querySelector("#btnValidarCpf")
...
function validaCPF(cpf) {
    ...
    if (cpf.length == 11) {
        ...
        return "tamanho do cpf excedido"
    }
...
var btnTelefone = document.querySelector("#btnCriarTelefone")
...
btnTelefone.addEventListener("click", ()=>{
    ...
    var telefonesGerados = document.querySelector("#telefones")
    var telefones = gerarTelefones(inputDDD.value, inputTel.value)


    telefones.forEach(function (telefone){
        telefonesGerados.innerHTML += telefone
    });
